...
public class SyncIfSlaveDatabaseEmpty implements Action<AppCore, Boolean> {
    ...
    public Boolean execute(AppCore app, Map<String, Object> params) 
        ...
        final Optional<PersistenceUnitContext> optSlavePuCtx = app
                .getMasterSlavePersistenceContext().getSlaveOptional();
        ...
        if(!optSlavePuCtx.isPresent()) {
            ...
            for(Class entityType : puClasses) {
                ...
                final Long count = this.count(slavePuCtx, entityType);
