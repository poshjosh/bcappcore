...
public class SettingsImpl extends HashMap<String, Object> implements Settings {
     ...
     */
    @Override
    public void updateAll(AppCore app, Map<? extends String, ? extends Object> m) throws IOException {
        for(Entry<? extends String, ? extends Object> entry : m.entrySet()) {
            this.update(app, entry.getKey(), entry.getValue(), false);
        }
    }
     ...
     */
    @Override
    public Object update(AppCore app, String name, Object newValue) throws IOException {
        return this.update(app, name, newValue, false);
    }
    ...
    public Object set(String name, Object newValue) {
        ...
        if(type == String.class) {
            ...
            value = data.set(name, (String)newValue);
        }
        return value;
    }
}
