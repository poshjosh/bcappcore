...
public interface Settings extends Map<String, Object> {
     ...
     */
    void updateAll(AppCore app, Map<? extends String, ? extends Object> m) throws IOException;
     ...
     * @throws java.io.IOException 
     */
    Object update(AppCore app, String name, Object newValue) throws IOException;
